...
_REPO_LINK = "https://github.com/Aetherinox/ghcr-docker-badges"
        ...
        return jsonify(
            {
                ...
                "example_paths": [
                    "/",
                    "/Aetherinox/ghcr-docker-badges/tags",
                    "/Aetherinox/ghcr-docker-badges/latest_tag",
                    "/Aetherinox/ghcr-docker-badges/size",
...
def get_tags(package_owner: str, package_name: str) -> Response:
    ...
    ----------
    package_owner : str
        package owner name, e.g. 'badges'
    package_name : str
        package name, e.g. 'badges'
